    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                ...
                .tags(List.of(
                        ...
                        new Tag().name("주문").description("미국 해외주식 예약주문 접수 및 다음 주문 미리보기"),
                        new Tag().name("대시보드").description("거래 내역, 포트폴리오 스냅샷 조회"),
                        new Tag().name("통계").description("KIS API 기반 계좌별 손익·체결·잔고·증거금·예약주문 조회"),
