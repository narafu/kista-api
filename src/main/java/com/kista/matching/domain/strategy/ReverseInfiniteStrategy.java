...
public class ReverseInfiniteStrategy {
    ...
    public List<PlannedOrder> buildFirstDayOrders(ReverseModePosition position, LocalDate tradeDate) {
        ...
        return List.of(PlannedOrder.of(tradeDate, position.ticker(), MOC, SELL, mocSellQuantity,
    ...
    public List<PlannedOrder> buildOrders(ReverseModePosition position, LocalDate tradeDate) {
        ...
        if (locBuyQuantity >= 1 && position.starPointPrice() != null) {
            ...
            orders.add(PlannedOrder.of(tradeDate, position.ticker(), LOC, BUY, locBuyQuantity,
    ...
    private List<PlannedOrder> buildQuotaExhaustedOrders(ReverseModePosition position, LocalDate tradeDate) {
