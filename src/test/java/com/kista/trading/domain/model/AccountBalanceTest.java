...
class AccountBalanceTest {
    ...
    void emptyExecutions_returnsUnchanged() {
        ...
        AccountBalance result = balance.applyExecutions(AccountBalance.Fill.listOf(List.of()));
    ...
    void pureBuy_weightsAvgPrice() {
        ...
        AccountBalance result = balance.applyExecutions(AccountBalance.Fill.listOf(List.of(buy(50, "30.00"))));
    ...
    void partialSell_avgPriceUnchanged() {
        ...
        AccountBalance result = balance.applyExecutions(AccountBalance.Fill.listOf(List.of(sell(100, "30.00"))));
    ...
    void sellThenBuySameDay_correctAvg() {
        ...
        AccountBalance balance = new AccountBalance(100, new BigDecimal("25.00"), new BigDecimal("5000"));
        AccountBalance result = balance.applyExecutions(AccountBalance.Fill.listOf(List.of(sell(50, "30.00"), buy(30, "30.00"))));
    ...
    void startFromZero_avgPriceIsFirstBuy() {
        ...
        AccountBalance result = balance.applyExecutions(AccountBalance.Fill.listOf(List.of(buy(100, "25.00"))));
