...
class SoxlDivisionStrategyTest {
    ...
    void case_q0() {
        // A=20, M=0, D=2000, B=2000, K=100.00, T=0, S=0.2000, P=24.00
    ...
    void case_q10_t1() {
        // A=20, M=200, D=2800, B=3000, K=150.00, T=floor(200/150)=1, S=0.1800, P=24.00
    ...
    void case_q100_t5() {
        // A=5, M=500, D=1500, B=2000, K=100.00, T=floor(500/100)=5, S=0.1000, P=6.00
