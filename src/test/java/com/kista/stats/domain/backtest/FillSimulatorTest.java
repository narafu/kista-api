...
class FillSimulatorTest {
    ...
    private static Order order(OrderType orderType, OrderDirection direction, BigDecimal price) {
    ...
    void fillsMocAlwaysTrue() {
        Order moc = order(OrderType.MOC, OrderDirection.BUY, new BigDecimal("100.00"));
    ...
    void fillsLocBuyBoundaryEqual() {
        Order loc = order(OrderType.LOC, OrderDirection.BUY, new BigDecimal("100.00"));
    ...
    void fillsLocSellBoundaryEqual() {
        Order loc = order(OrderType.LOC, OrderDirection.SELL, new BigDecimal("100.00"));
    ...
    void fillsLimitStillUsesClosingPriceNotOhlc() {
        ...
        Order limit = order(OrderType.LIMIT, OrderDirection.BUY, new BigDecimal("100.00"));
    ...
    void simulateLimitBuyTouchesLow() {
        Order fillable = order(OrderType.LIMIT, OrderDirection.BUY, new BigDecimal("100.00"));
        ...
        Order unfillable = order(OrderType.LIMIT, OrderDirection.BUY, new BigDecimal("100.00"));
    ...
    void simulateLimitSellTouchesHigh() {
        Order fillable = order(OrderType.LIMIT, OrderDirection.SELL, new BigDecimal("100.00"));
        ...
        Order unfillable = order(OrderType.LIMIT, OrderDirection.SELL, new BigDecimal("100.00"));
    ...
    void simulateLocMocIgnoreHighLow() {
        ...
        Order moc = order(OrderType.MOC, OrderDirection.SELL, new BigDecimal("999.00"));
    ...
    void simulateUsesOrderLegAsExternalOrderId() {
        Order withLeg = order(OrderType.MOC, OrderDirection.BUY, new BigDecimal("100.00"))
