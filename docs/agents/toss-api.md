...
- KIS API와 필드명·인증 방식이 다르므로 혼용 주의 (`TossApiException` → 503 매핑은 `GlobalExceptionHandler`가 SSOT, 브로커 분기는 `docs/agents/modules/broker.md` "BrokerAdapter Registry 패턴" 참고)
