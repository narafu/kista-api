...
- `V23__add_order_leg_and_order_indexes.sql`은 `orders.order_leg`와 scheduler/reservation 조회용 orders 인덱스를 추가한다. 후속 orders 쿼리 변경 시 해당 인덱스 prefix와 조회 조건을 함께 확인한다.
