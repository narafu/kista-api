...
import com.kista.marketcalendar.application.port.output.MarketCalendarRefreshPort;
import com.kista.marketcalendar.application.port.output.MarketHolidayStorePort;
...
public class AlpacaCalendarAdapter implements MarketCalendarRefreshPort {
    ...
    private final RestClient marketAlpacaRestClient;
    ...
    private List<CalendarEntry> fetchTradingDays(LocalDate start, LocalDate end) {
        ...
        List<CalendarEntry> entries = marketAlpacaRestClient.get()
                .uri(url)
