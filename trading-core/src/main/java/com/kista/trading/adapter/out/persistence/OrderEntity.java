...
class OrderEntity extends BaseAuditEntity {
    ...
    private LocalDate tradeDate; // KST 거래일 — DB·도메인 동일 기준 (V28에서 US→KST shift 완료)
    ...
    private OrderStatus status; // PLANNED/PLACED/FILLED/PARTIALLY_FILLED/FAILED/CANCELLED
