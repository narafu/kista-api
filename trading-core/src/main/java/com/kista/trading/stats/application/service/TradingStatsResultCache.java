...
// TradingStatsService(summary/equity-curve/cycles) 전용 인메모리 TTL 캐시 — com.kista.stats.application.service.StatsResultCache
...
class TradingStatsResultCache {
    ...
    @Autowired
    TradingStatsResultCache() {
        this(Clock.systemUTC());
    }

    TradingStatsResultCache(Clock clock) {
        this.clock = clock;
    }
