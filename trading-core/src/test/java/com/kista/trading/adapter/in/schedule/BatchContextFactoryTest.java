...
class BatchContextFactoryTest {
    ...
    void buildAll_returnsContextsForAllStrategies() {
        ...
        TradingUserProfile userProfile = mockUserProfile();
        ...
        when(tradingUserProfilePort.findAllByUserIds(List.of(USER_ID))).thenReturn(Map.of(USER_ID, userProfile));
    ...
    void buildAll_emptyStrategies_returnsEmptyList() {
        ...
        when(tradingUserProfilePort.findAllByUserIds(List.of())).thenReturn(Map.of());
    ...
    void buildAll_contextBuildFails_skipsFailedStrategyAndNotifiesAdmin() {
        ...
        verify(errorReportPort).reportError(argThat(e -> e instanceof NoSuchElementException));
