...
class BuyOrderPriceCapperTest {
    ...
    private Order vrLadderBuy(String price, int quantity) {
        return new Order(null, null, null, TODAY, StrategyTicker.TQQQ, OrderType.LIMIT,
                OrderTiming.AT_OPEN, OrderDirection.BUY, quantity, new BigDecimal(price), OrderStatus.PLANNED, null, null, null);
    }

    private Order vrLadderSell(String price, int quantity) {
        return new Order(null, null, null, TODAY, StrategyTicker.TQQQ, OrderType.LIMIT,
                OrderTiming.AT_OPEN, OrderDirection.SELL, quantity, new BigDecimal(price), OrderStatus.PLANNED, null, null, null);
    }
